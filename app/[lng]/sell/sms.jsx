...
export default function LoginWithPhone({ email }) {
  ...
  const handleSentOtp = async () => {
    try {
      setIsLoading(true);
      const formattedPhoneNum = `${selectedCountry.code}${phoneNum.replace(
        /\D/g,
        ""
      )}`;
  ...
  return (
    <div className="">
      ...
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg dark:bg-zinc-800  overflow-hidden">
          ...
          {otpSent ? (
            ...
            <div className="flex flex-col gap-4 ">
              ...
              <Button
                ...
                className="mx-4 bg-green-500 text-white"
              >
                {isLoading && <LoadingSpinner />}
