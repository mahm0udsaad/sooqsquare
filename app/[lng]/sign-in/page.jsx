...
const DynamicLoginWithPhone = dynamic(() => import("../sell/sms"), {
  ssr: false,
});
          ...
          <Card className="max-w-lg w-full">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 text-sm">
                To access your account, please sign in using your Google account
                or your registered email and password. If you don't have an
                account yet, you can create one by clicking on the "Sign Up"
                link below.
              </p>
              <Gbtn />
              <Fbtn />
            ...
            <CardFooter className="text-center">
              <p className="text-gray-500">
                We will not reveal your email to anyone else or use it to send
