...
import {
  PublishBtn,
  SaveBtn,
} from "../../../components/component/buttons/formBtns";
import {
  DialogTitle,
  DialogDescription,
  DialogHeader,
...
const SellForm = async ({ params: { lng }, searchParams }) => {
  ...
  const Selectors = dynamic(
    () => import(`@/components/shopAdsForms/selectors`),
    {
      ssr: false,
  ...
  const CarBrandSelector = dynamic(
    () => import(`@/components/carBrandSelection`),
    {
      ssr: false,
      loading: () => <SkeletonScreen />,
    }
  );
  const LocationDetails = dynamic(
  ...
  const ExtraFeatures = dynamic(
    () => import(`@/components/shopAdsForms/extraFeatures`),
    {
      ssr: false,
      loading: () => <DropdownSkeleton />,
    }
  );
  const CarChassis = dynamic(
    () => import(`@/components/shopAdsForms/carChassis`),
    {
      ssr: false,
      loading: () => <DropdownSkeleton />,
    }
  );
  const PriceSelection = dynamic(
    () => import(`@/components/shopAdsForms/priceForm`),
    {
      ssr: false,
      loading: () => <DropdownSkeleton />,
    }
  );
  const NameDescriptionSelector = dynamic(
    () => import(`@/components/NameDescriptionSelector`),
    {
      ssr: false,
      loading: () => <DropdownSkeleton />,
    }
  ...
  const ColorPicker = dynamic(
    () => import(`@/components/shopAdsForms/colorPicker`),
    {
      ssr: false,
      loading: () => <DropdownSkeleton />,
    }
        ...
        <div className="w-full">
          <div className="w-full">
            {!searchParams.profile ? (
              <SelectProfile lng={lng} user={user} />
            ) : null}
            ...
            {!searchParams.uploadedImages &&
              ...
              searchParams.profile && <MultiImageForm lng={lng} />}
            {!searchParams.brand && searchParams.city && (
              <CarBrandSelector lng={lng} />
            )}
            {!searchParams.color && searchParams.model && (
              <ColorPicker lng={lng} />
            )}
            {!searchParams.carChassis && searchParams.carStatus && (
              <CarChassis lng={lng} />
            )}
            {!searchParams.price && searchParams.carChassis && (
              <PriceSelection lng={lng} />
            )}
            {!searchParams.name && searchParams.price && (
              <NameDescriptionSelector lng={lng} />
            )}
            {searchParams.paintType && <ExtraFeatures lng={lng} />}
            {searchParams.carStatus && (
              <LocationDetails user={user} lng={lng} />
            )}
                  ...
                  <form action={saveAd}>
                    {searchParams.profile === "mainProfile" ? (
                      ...
                      <Input
                        ...
                        id={"shop"}
                        name={"shop"}
                        value={searchParams.profile?.split("=")[1]}
                        readOnly
                      />
                    )}
                    <Input
