...
export const CategroyLink = ({ icon, text ,link}) => {
    return (
        <Link href={`/vehicle`} className={`flex items-center hover:text-white justify-center dark:text-white border border-[#F34A62] rounded-xl lg:px-2 py-5 hover:bg-red-600 cursor-pointer transition`}>
