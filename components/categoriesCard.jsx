...
export const AdCategroy = ({ lng ,icon, text }) => {
    ...
    return (
        <Link href={`?category=${text}`} className={`flex border border-rose-500 text-zinc-800 hover:text-white items-center justify-center border rounded-xl px-4 py-8 dark:text-white  hover:bg-gradient-to-r hover:from-rose-400 hover:to-blue-500  cursor-pointer transition`}>
        <div className="text-2xl mx-3">
            {icon}
        </div>
