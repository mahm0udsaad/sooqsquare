...
export const AdCategroy = ({ lng ,icon, text }) => {
    ...
    return (
        <Link href={`?category=${text}`} className={`flex bg-zinc-800 text-white items-center justify-center border rounded-full px-4 py-8 hover:dark:bg-zinc-800 hover:bg-zinc-600 cursor-pointer transition`}>
