...
import ApplyBtn from "../../app/[lng]/jobs/findJob/components/applyBtn";

export default async function JobPage({ job, lng, searchParams }) {
      ...
      <div className="p-4 rounded-xl shadow-lg space-y-4  bg-gray-100 dark:bg-gray-800">
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row">
            <ApplyBtn searchParams={searchParams} jobId={job.id} lng={lng} />
          </div>
        </div>
      </div>
