      ...
      <div className="flex flex-col items-start justify-center space-y-4 md:w-1/2 md:pl-8">
        ...
        <div className="p-4 flex gap-3">
          ...
          <Button
            ...
            className="bg-transparent border border-rose-600 text-rose-600 hover:bg-rose-600 hover:text-white w-1/2 flex justify-center items-center space-x-2"
          >
          ...
          {ad.adStatus === "active" ? (
            <Button
              onClick={() => handleChanginAdStatus(ad.id, "inActive")}
              className="bg-transparent border border-yellow-600 hover:bg-yellow-600 hover:text-white text-yellow-600  w-1/2 flex justify-center items-center space-x-2"
            >
              {adStatusLoading ? (
                <svg
                  className="animate-spin text-rose-800 h-5 w-5 mr-3 spinner_z9k8"
            ...
            <Button
              onClick={() => handleChanginAdStatus(ad.id, "active")}
              className="bg-transparent border border-green-600 hover:bg-green-600 hover:text-white text-green-600  w-1/2 flex justify-center items-center space-x-2"
            >
              {adStatusLoading ? (
                <svg
                  className="animate-spin text-rose-800 h-5 w-5 mr-3 spinner_z9k8"
