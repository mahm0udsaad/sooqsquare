        ...
        <Card>
          ...
          <CardContent className='flex flex-col gap-4'>
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <Link href={`/profile/${ad.user?.id ? ad.user.id : ad.shop.userId}`} className="w-1/2 py-2 px-4 rounded-md hover:bg-zinc-900 hover:text-white dark:hover:bg-white dark:hover:text-black mx-1 flex items-center border border-black dark:border-white dark:text-white justify-center gap-2 transition">
