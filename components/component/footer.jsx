...
export default function Footer({ user }) {
  ...
  useEffect(() => {
    ...
    if (pathname.split("/")[2] === "jobs" && !user?.country) {
      fetchLocation();
    }
  }, []);
  return (
    <footer className="w-full border-t-[1px] bg-gray-950 dark:bg-zinc-950 mt-4 text-white py-12">
      <div className="container mx-auto grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-8 px-4">
        <div>
          <h3 className="font-bold text-lg mb-3">About Us</h3>
          <p className="text-sm">
            We are a leading car marketplace committed to connecting car buyers
            with trusted sellers. Our mission is to make car buying and selling
