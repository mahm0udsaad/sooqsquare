    ...
    <Drawer>
      <DrawerTrigger asChild>
        <Button className="bg-transparent hover:bg-transparent py-0 px-0 h-full">
          <div className="flex justify-between self-start lg:w-auto w-full px-20  cursor-pointer py-12 rounded-[35px]  main-bg items-center ">
            ...
            <div className="space-y-1 w-[25%]">
              <Label className="cursor-pointer" htmlFor="avatar-image">
                ...
                <Avatar className="w-32 h-32 border-4 border-white">
                  <AvatarImage
                    alt="Shop owner"
                    src={shopImage || "/new-placeholder-avatar.jpg"}
                  />
