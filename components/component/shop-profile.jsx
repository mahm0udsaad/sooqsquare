      ...
      <main className="container mx-auto px-4 py-8 space-y-4">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex items-start justify-end gap-4">
            <Toggle
              onClick={() => handleBgColorChange("#ef4444")}
              aria-label="Toggle red"
              className={`focus:border-2 focus:border-black focus:border bg-red-500 ${
                shop.bgColor === "#ef4444" ? "border border-black border-2" : ""
              }`}
            >
              <CircleIcon className="h-4 w-4" />
            </Toggle>
            <Toggle
              onClick={() => handleBgColorChange("#22c55e")}
              aria-label="Toggle green"
              className={`focus:border-2 focus:border-black focus:border bg-green-500 ${
                shop.bgColor === "#22c55e" ? "border border-black border-2" : ""
              }`}
            >
              <CircleIcon className="h-4 w-4" />
            </Toggle>
            <Toggle
              onClick={() => handleBgColorChange("#3b82f6")}
              aria-label="Toggle blue"
              className={`focus:border-2 focus:border-black focus:border bg-blue-500 ${
                shop.bgColor === "#3b82f6" ? "border border-black border-2" : ""
              }`}
            >
              <CircleIcon className="h-4 w-4" />
            </Toggle>
            <Toggle
              onClick={() => handleBgColorChange("#eab308")}
              aria-label="Toggle yellow"
              className={`focus:border-2 focus:border-black focus:border bg-yellow-500 ${
                shop.bgColor === "#eab308" ? "border border-black border-2" : ""
              }`}
            >
              <CircleIcon className="h-4 w-4" />
            </Toggle>
            <Toggle
              onClick={() => handleBgColorChange("#f3f4f6")}
              aria-label="Toggle yellow"
              className={`focus:border-2 focus:border-black focus:border bg-f3f4f6-500 ${
                shop.bgColor === "#f3f4f6" ? "border border-black border-2" : ""
              }`}
            >
              <CircleIcon className="h-4 w-4" />
            </Toggle>
