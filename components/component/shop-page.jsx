...
export default function ShopPage({ shop, user, lng, isFollowed }) {
  ...
  return (
    <>
      ...
      <main
        style={{ backgroundColor: shop?.bgColor ? shop.bgColor : "" }}
        className={`${
          shop.bgColor && shop?.bgColor !== "#f3f4f6"
            ? `text-white`
            : "text-black"
        ...
        <div className="flex  justify-between space-x-4">
          ...
          <div className="flex gap-4">
            ...
            <form action={addUserFollow}>
              ...
              <input type="hidden" name="followedShopId" value={shop?.id} />
