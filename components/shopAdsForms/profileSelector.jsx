        ...
        <div className="grid lg:grid-cols-4 justify-items-center grid-cols-2 justify-center items-center gap-8 p-4">
          <Card className="relative w-64 shadow-lg rounded-lg overflow-hidden border border-green-500 rounded-lg shadow-md bg-white dark:bg-zinc-800">
            <CardContent className="flex flex-col items-center p-4">
              <Badge className="mb-2 absolute top-0 z-50 main-bg text-white rounded-md px-2 py-1">Main Profile</Badge>
              <Avatar className="w-24 h-24 mb-4">
                <AvatarImage alt="User Name 1" src={user.image} />
                <AvatarFallback>UN1</AvatarFallback>
              </Avatar>
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{user.username}</h2>
          ...
          <Card key={shop.id} className="w-64 shadow-lg rounded-lg overflow-hidden rounded-lg shadow-md bg-white dark:bg-zinc-800">
            <CardContent className="flex flex-col items-center p-4">
              ...
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{shop.shopName}</h2>
