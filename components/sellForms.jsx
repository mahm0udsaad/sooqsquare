...
export const CarForSellAd = ({ lng, userId }) => {
  const NameDescriptionSelector = dynamic(
    () => import(`./NameDescriptionSelector`),
    {
      ssr: false,
    }
  );
...
export const ModelSelection = ({ lng }) => {
  ...
  const modelSelectionProps = {
    ...
    paramsToCheck: ["category", "uploadedImages", "location"],
  };
